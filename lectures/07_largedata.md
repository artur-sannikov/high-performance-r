...
# Improve code: memory-handling tips from day 1
...
- only one name bound to object &rarr; modified in place, no copy created
...
-   uses threading &rarr; built-in parallelism
