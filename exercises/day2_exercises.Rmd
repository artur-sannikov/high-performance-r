---
title: "High Performance R exercises - day 2"
output: md_document
---
...
comm_csv_list <- list.files(path = "/scratch/project_2016453/helijuot/communities/", pattern = ".csv", full.names = TRUE)

registerDoParallel(cores = 3) #registering a backend for foreach

stress_values <- c(length(comm_csv_list)) # create an empty vector of final length
...
### Ex 16: Multiprocessing with `future`
...
# Specify a temp folder path (add your personal folder here)
echo "TMPDIR=/scratch/project_2016453/personal/<your folder here>" >> ~/.Renviron 
