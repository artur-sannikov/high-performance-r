...
```{r ex1, echo=F, fig.width=5, fig.height=3.5}
sizes <- 100000 * 2^(1:7)
...
Repeat the exercise, but with $x$ being a data frame instead of a matrix.
...
```{r ex4, echo=F, fig.width=5, fig.height=3.5}
...
```{r ex5, echo=F, fig.width=5, fig.height=3.5}
plot_memory()
```
...
```{r ex11, fig.width=5, fig.height=3.5}
...
```{r ex12a, echo=F, fig.width=5, fig.height=3.5}
Rprof(memory.profiling=T)
...
```{r ex12b, echo=F, fig.width=5, fig.height=3.5}
Rprof(memory.profiling=T)
